  ...
  <div id="tartalom" class="my-5 d-flex flex-column justify-content-center align-items-center">
    <form @submit.prevent="login" class="needs-validation rounded bg-dark p-4" id="form" novalidate>
      ...
      <div class="mb-4">
        ...
        <input type="name" class="form-control form-control-md text-light border-dark" id="username" v-model="name"
      ...
      <div class="mb-4">
        ...
        <input type="password" class="form-control form-control-md text-light border-dark" id="password"
