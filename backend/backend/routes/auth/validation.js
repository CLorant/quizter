...
[
    ...
    check('password').isLength({min: 8}).withMessage("Fos a jelszó, 8 karaktert").matches(/\d/).withMessage("Jelszóba legyen 1 betűd").matches(/[!@#$%^&*(),.?":{}|<>]/).withMessage("Jelszóba legyen 1 speciális karakter "),
